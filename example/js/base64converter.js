...
var _bc = new Base64Converter();
var _url = encodeURI('imgs/img.png');
var _src = _bc.convertImgDataURL(_url);
window.onload = function(){
    var _div = document.getElementById('hoge');
    _div.innerHTML = '<img src=' + _src + '>';
};